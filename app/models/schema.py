...
class MaterialInfo:
    ...
    preview_images: Optional[list] = None  # List of preview frame URLs
...
class VideoParams(BaseModel):
    ...
    video_aspect: Optional[VideoAspect] = VideoAspect.portrait.value  # type: ignore
    video_concat_mode: Optional[VideoConcatMode] = VideoConcatMode.random.value  # type: ignore
